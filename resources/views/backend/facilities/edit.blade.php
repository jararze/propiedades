...
<x-app-layout>
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Servicios cercanos</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Editar servicios</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                ...
                                <form class="row g-3" method="post" action="{{ route('admin.Facilities.edit.info') }}">
                                    @csrf
{{--                                    @method('patch')--}}
                                    <div class="col-12">
                                        <label for="name" class="form-label">Nombre</label>
                                        <input id="id" name="id" type="hidden" class="form-control" value="{{ $facility->id }}">
                                        <input id="name" name="name" type="text" class="form-control" placeholder="Amenitie" value="{{ $facility->name }}">
                                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                    </div>
                                    <div class="col-12">
                                        <label for="icon" class="form-label">Icono</label>
                                        <input id="icon" name="icon" type="text" class="form-control" placeholder="Amenitie" value="{{ $facility->icon }}">
                                ...
                                @if (session('status') === 'updated')
                                    <div class="alert border-0 bg-light-success alert-dismissible fade show py-2"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <div class="text-success">Servicio cercano actualizado.</div>
                                            </div>
                                        </div>
