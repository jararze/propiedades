                                                ...
                                                <div class="modal fade" id="soldpropertie{{ $item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content bg-success">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title text-white">
                                                                    ¿Marcar el proyecto {{ $item->name }} fuera del
                                                                    mercado?</h5>
                                                                <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal"
                                                                        aria-label="Close"></button>
                                                            ...
                                                            <div class="modal-body text-white">
                                                                <p>¿Esta seguro que el proyecto fue
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{ route('admin.project.sold',['id' => $item->id]) }}"
                                ...
                                @if (session('status') === 'eliminated')
                                    <div class="alert border-0 bg-light-success alert-dismissible fade show py-2"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <div class="text-success">Proyecto eliminada.</div>
                                            </div>
                                        </div>
