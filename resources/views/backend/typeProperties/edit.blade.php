    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Editar tipo propiedades</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Editar tipo propiedades</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                ...
                                <form class="row g-3" method="post" action="{{ route('admin.TypesProperties.edit.info') }}">
                                    @csrf
{{--                                    @method('patch')--}}
                                    <div class="col-12">
                                        <label for="type_name" class="form-label">Nombre</label>
                                        <input id="id" name="id" type="hidden" class="form-control" value="{{ $property->id }}">
                                        <input id="type_name" name="type_name" type="text" class="form-control" placeholder="Nombre tipo propiedad" value="{{ $property->type_name }}">
                                        <x-input-error :messages="$errors->get('type_name')" class="mt-2" />
                                    </div>
                                    <div class="col-12">
                                        <label for="type_icon" class="form-label">Ícono</label>
                                        <input id="type_icon" name="type_icon" type="text" class="form-control" placeholder="Ícono" value="{{ $property->type_icon }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea id="description" name="description" class="form-control" rows="3" cols="3" placeholder="Descripcion tipo propiedad">{{ $property->description }}</textarea>
                                ...
                                @if (session('status') === 'property-updated')
                                    <div class="alert border-0 bg-light-success alert-dismissible fade show py-2"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <div class="text-success">Tipo de propiedad actualizada.</div>
                                            </div>
                                        </div>
