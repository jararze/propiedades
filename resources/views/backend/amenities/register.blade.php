...
<x-app-layout>
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Agregar Amenities</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Agregar Amenities</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Agregar amenitie</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                <form class="row g-3" method="post" action="{{ route('admin.Amenities.register') }}">
                                    @csrf
                                    <div class="col-12">
                                        <label for="name" class="form-label">Nombre Amenitie</label>
                                        <input id="name" name="name" type="text" class="form-control" placeholder="Nombre Amenitie">
                                ...
                                @if (session('status') === 'created')
                                    <div class="alert border-0 bg-light-success alert-dismissible fade show py-2"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <div class="text-success">Amenitie creada.</div>
                                            </div>
                                        </div>
