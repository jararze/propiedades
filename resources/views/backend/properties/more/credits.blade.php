...
<x-app-layout>
    ...
    <main class="page-content">
        ...
        <h6 class="mb-20 text-uppercase">Lista de paquetes disponibles</h6>
        <h7 class="mt-10 text-bg-danger p-1 text-uppercase" style="font-weight: bold">Sobrepasaste el limite de propiedades publicadas en tu plan. Por favor adquiere un nuevo plan.</h7>
        <hr/>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mt-3 d-grid d-lg-block">
                                <form action="{{ route("admin.packages.user.add") }}" method="post">
                                    ...
                                    <button type="submit" class="btn btn-outline-light rounded-0 px-4 shadow">Comprar
                                        ahora
                                    </button>
                                </form>
                            </div>
        ...
        @if (session('status') === 'updated')
            <div class="alert border-0 bg-light-success alert-dismissible fade show py-2"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <div class="text-success">Paquete Comprado. El administrador debe aprobar la compra para que
                            pueda usar los creditos.
                        </div>
                    </div>
                </div>
