                                    ...
                                    @foreach($values as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href=""><span
                                                            class="badge bg-light-danger text-danger w-100">Inactivo</span></a>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <button type="button" class="badge bg-light-danger text-danger w-100" data-bs-toggle="modal"
                                                       data-bs-target="#exampleDangerModal{{ $item->id }}"><i
                                                            class="bi bi-radioactive"></i>Activar</button>
                                                </div>
                                                        ...
                                                        <div class="modal-content bg-info">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title text-white">
                                                                    ¿Sacar del mercado {{ $item->name }}?</h5>
                                                                <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal"
                                                                        aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body text-white">
                                                                <p>¿Esta seguro que aprobaras poner a la venta, anticretico o ya alquilada la propiedad?</p>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('admin.properties.sold.status') }}"
                                                                      method="POST">
                                                                    @csrf
