...
<script type="text/javascript">
    function initMap() {
        ...
        for (const location of locations) {
            ...
            //     '<img src="' + thumbUrl + '" alt="Porcelain Factory of Vista Alegre">' +
            //     '<p>' + location.property_status + '</p>' +
            //     '<p> Cuartos:' + location.bedrooms + '</p>' +
            //     '<p> Baños:' + location.bathrooms + '</p>' +
            //     '<div class="iw-subTitle">Informacíon</div>' +
            //     '<p>' + location.short_description + '</p>' +
            //     '</div>' +
            //     '<div class="iw-bottom-gradient"></div>' +
            //     '</div>';
