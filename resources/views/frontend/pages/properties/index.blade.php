                                        ...
                                        <div class="inner-box">
                                            ...
                                            <div class="lower-content">
                                                <div class="title-text">
                                                    <h4>
                                                        <a href="{{ route('front.properties.inner', $featured_propery->id) }}">{{ $featured_propery->name }}</a>
                                                    </h4>
                                                </div>
                                                ...
                                                <div class="other-info-box clearfix">
                                                    <div class="btn-box pull-left">
                                                        <a href="{{ route('front.properties.inner', $featured_propery->id) }}"
                                                           class="theme-btn btn-two">Ver más</a>
                                                    </div>
                                                    <ul class="other-option pull-right clearfix">
                                                        <li>
                                                            <a href="{{ route('front.properties.inner', $featured_propery->id) }}"><i
                                                                    class="icon-12"></i></a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('front.properties.inner', $featured_propery->id) }}"><i
                                                    ...
                                                    <div class="lower-content">
                                                        <div class="author-info clearfix">
                                                            ...
                                                            <div class="buy-btn pull-right">
                                                                <a href="{{ route('front.properties.inner', $featured_propery->id) }}">{{ $featured_propery->property_status }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="title-text">
                                                            <h4>
