                ...
                <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms"
                        ...
                        <div class="inner-box" style="min-height: 735px !important;">
                            <div class="image-box">
                                <figure class="image">
                                    <img alt="{{ $featured_propery->name }}" src="{{ (!empty($featured_propery->thumbnail)) ? url('upload/properties/' .  $featured_propery->code . "/" . $featured_propery->thumbnail) : url('upload/No_Image_Available.jpg') }}">
                                </figure>
                                ...
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb">
                                            <img alt="" src="{{ (!empty($featured_propery['agent']['photo'])) ? url('upload/profiles/'.$featured_propery['agent']['photo']) : url('upload/No_Image_Available.jpg') }}">
                                        </figure>
