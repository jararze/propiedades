(function($) {
	...
	if($('.price-range-slider').length){
		...
		$( "input.property-amount" ).val( $( ".price-range-slider" ).slider( "values", 0 )  + " - " +  $( ".price-range-slider" ).slider( "values", 1 ) + " $us" );
	}
	...
	if($('.area-range-slider').length){
		...
		$( "input.area-range" ).val( $( ".area-range-slider" ).slider( "values", 0 )  + " - " + $( ".area-range-slider" ).slider( "values", 1 ) + " mt2" );
	}
	...
	if ($('.property-details .bxslider').length) {
		$('.property-details .bxslider').bxSlider({
	        ...
	        nextText: '<i class="fa-solid fa-angles-right"></i>',
	        prevText: '<i class="fa-solid fa-angles-left"></i>',
	        mode: 'fade',
	        auto: 'true',
	        speed: '700',
